...
add_action('admin_enqueue_scripts', function($hook) {
    ...
    // FullCalendar
    wp_enqueue_script('fullcalendar-js', PLUGIN_DIR_URL . 'assets/js/FullCalendar.min.js', [], '6.1.8', true);

    // SortableJS for Kanban
    wp_enqueue_script('sortable-js', PLUGIN_DIR_URL . 'assets/js/Sortable.min.js', [], '1.15.0', true);
